...
import { BoardCard, CARD, OceanCard, ResortCard } from './cards'
...
// A shared CDN copy is the only cache in front of this route, so its lifetime
// tracks `cacheLife('hours')` on the NOAA reads underneath it.
 ...
 *
 * @remarks
 * - A route handler, not `opengraph-image`, because the board is a query state.
 * - Every number comes from the same cached NOAA reads the page renders from.
 */
